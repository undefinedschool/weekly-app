<script>
  ...
  let completedPercentage =
    JSON.parse(localStorage.getItem(LOCAL_STORAGE_COMPLETED_KEY)) || 0;
  ...
  function addCompletedPercentage() {
    ...
    localStorage.setItem(
      ...
      JSON.stringify(completedPercentage)
    );
  }
...
<main
  class="flex flex-col h-screen justify-center items-center p-3 bg-black-us">
      ...
      <div class="sm:h-64 h-auto overflow-scroll">
        <div class="border-1 rounded p-3">
          ...
          <div class="sm: leading-snug leading-tight">
            <div class="mb-2">
              <label
                class="{items[0] ? 'line-through' : ''} inline-flex items-center">
                <input
                  type="checkbox"
            ...
            <div>
              <label
                class="{items[1] ? 'line-through' : ''} inline-flex items-center">
                <input
                  type="checkbox"
                  class="form-checkbox text-cyan-us transition-all-4"
        ...
        <div class="mt-1 border-1 rounded p-3">
          <CSSTag />

          <div class="sm: leading-snug leading-tight">
            <div class="mb-2">
              <label
                class="{items[2] ? 'line-through' : ''} inline-flex items-center">
                <input
                  type="checkbox"
                  class="form-checkbox text-cyan-us transition-all-4"
